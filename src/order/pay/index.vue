    ...
    <div class="page-box bg-gray-bg box-border">
        ...
        <div class="p-20px pb-80px box-border" v-if="order.id">
            ...
            <div class="bg-white mt-10px p-15px rounded-10px" v-if="order.is_autonym == 1">
                <idcard-select :maxSelect="maxSelectIdcard" :curSelect="curIdacrds" :cinema_id="cinema_id"
                    @onChange="onChangeIdcards"></idcard-select>
            </div>
...
import IdcardSelect from '@/order/idcard/components/idcard-select.vue';
import MyPhoneButton from '@/components/my-phone-button/index.vue';
export default {
    components: { AddressList, IdcardSelect, MyPhoneButton },
    data() {
        return {
